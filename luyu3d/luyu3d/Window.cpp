...
LRESULT Window::HandleMsg(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam) noexcept
{
	...
	case WM_KILLFOCUS:
		kbd.ClearState();
		break;
		//clear keystate when window loses focus to prevent input
		/****************KEYBOARD MESSAGES*********************/
	case WM_KEYDOWN:
	...
	{
		const POINTS pt = MAKEPOINTS(lParam);
		const int delate = GET_WHEEL_DELTA_WPARAM(wParam);
		mouse.OnWheelDelta(pt.x, pt.y, delate);
		break;
	}
...
{
	return "luyu Window Exception [No Graphics]";
}
